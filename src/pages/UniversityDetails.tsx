...
import { ArrowLeft, Building2, BookOpen, FileText, Users, TrendingUp, CheckCircle, Plus, Settings, Mail, MapPin } from 'lucide-react';
        ...
        <Card className="border-2">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button size="sm" variant="outline" onClick={() => navigate('/universities/add')}>
                <Plus className="w-4 h-4 mr-2" />
                Add Program
              </Button>
            </div>
          ...
          <CardContent>
            {universityPrograms.length === 0 ? (
              <div className="text-center py-8">
                ...
                <Button className="mt-4" onClick={() => navigate('/universities/add')}>
                  <Plus className="w-4 h-4 mr-2" />
                  Add First Program
                </Button>
              </div>
