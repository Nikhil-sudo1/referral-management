...
import { universityWiseData, monthlyReferralData } from '@/data/mockData';
...
import { TrendingUp, BarChart3, PieChart, Activity, Sparkles, Target, Zap, TrendingDown } from 'lucide-react';
      ...
      <div className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <Badge className="gradient-success text-success-foreground border-0">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-card-foreground">
                    <AnimatedCounter end={12} duration={1500} suffix=" days" />
                  </p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-card-foreground">MIT</p>
                  <div className="flex items-center gap-1 mt-2">
                    <TrendingUp className="w-3 h-3 text-success" />
                    <span className="text-xs text-success">62% success rate</span>
                  </div>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-card-foreground">November</p>
                  <div className="flex items-center gap-1 mt-2">
                    <TrendingUp className="w-3 h-3 text-success" />
                    <span className="text-xs text-success">42 referrals</span>
                  </div>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-card-foreground">MBA</p>
                  <div className="flex items-center gap-1 mt-2">
                    <TrendingUp className="w-3 h-3 text-success" />
                    <span className="text-xs text-success">45% of total</span>
                  </div>
                </div>
        ...
        <Card className="hover:shadow-xl transition-shadow border-2">
          ...
          <CardContent>
            <div className="space-y-6">
              {[
                { stage: 'Submitted', count: 156, color: 'bg-info', gradient: 'from-info to-blue-500' },
                { stage: 'Assigned', count: 142, color: 'bg-warning', gradient: 'from-warning to-orange-500' },
                { stage: 'Contacted', count: 118, color: 'bg-accent', gradient: 'from-accent to-purple-500' },
                { stage: 'Admitted', count: 67, color: 'bg-success', gradient: 'from-success to-emerald-500' },
              ].map((item, idx) => (
