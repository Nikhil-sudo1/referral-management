...
import { rewards, referrals } from '@/data/mockData';
...
const Rewards = () => {
  ...
  const totalDisbursed = rewards.filter((r) => r.status === 'disbursed').reduce((sum, r) => sum + r.amount, 0);
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-card-foreground">${totalPending}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-card-foreground">${totalDisbursed}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-card-foreground">{rewards.length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-medium text-card-foreground">
                            {reward.userType.charAt(0).toUpperCase() + reward.userType.slice(1)} Reward
                          </p>
                          <p className="text-sm text-muted-foreground">
                            Referral: {referral?.referralCode || 'N/A'}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <p className="text-lg font-semibold text-card-foreground">${reward.amount}</p>
                ...
                {rewards.map((reward) => {
                  ...
                  return (
                    <TableRow key={reward.id}>
                      ...
                      <TableCell className="capitalize">{reward.userType}</TableCell>
