      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">Programs - {university.name}</h1>
              <p className="text-muted-foreground mt-1">Manage programs and courses</p>
            </div>
          </div>
        ...
        {universityPrograms.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {universityPrograms.map((program) => {
              ...
              return (
                <Card key={program.id} className="hover:shadow-xl transition-all duration-300 border-2">
                  <CardHeader className="pb-3 bg-gradient-to-r from-primary/5 to-accent/5">
                    <div className="flex items-start justify-between">
                      <div>
                        <CardTitle className="text-xl">{program.name}</CardTitle>
                        <p className="text-sm font-mono text-primary mt-1">{program.code}</p>
                      </div>
                      <Badge
                        variant="outline"
                        className={
